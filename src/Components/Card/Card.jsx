...
// import pict from '../../images/arshil.jpg';
    ...
    <>
      <div className="card">
        <div className="card-info">
          {/* <div className="card-avatar"><img src={props.imag} alt="hello" /></div> */}
          <div className={`card-avatar card-${props.clsname}`}></div>
          <div className="card-title">{props.name}</div>
          <div className="card-subtitle">{props.designation}</div>
        </div>
